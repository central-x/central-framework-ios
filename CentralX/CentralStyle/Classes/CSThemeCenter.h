...
@class CSTheme;
@protocol CSThemeObserver;

/***************************************************************
 *  主题管理
 ***************************************************************/
@interface CSThemeCenter : NSObject
...
@property (nonatomic, strong, readonly)CSTheme *currentTheme;/**< 当前主题 */
@property (nonatomic, strong, readonly)NSString *currentThemeName;/**< 当前主题名字 */

- (void)applyThemeWithName:(NSString *)themeName;/**< 更新主题 */
- (void)applyToObserver:(id<CSThemeObserver>)observer;/**< 手动应用主题至该观察者 */

#pragma mark - 注册
- (void)registerTheme:(CSTheme *)theme forName:(NSString *)themeName;/**< 注册主题 */
- (void)registerObserver:(id<CSThemeObserver>)observer;/**< 注册观察者 */
 ...
 ***************************************************************/
@protocol CSThemeObserver <NSObject>
- (void)loadTheme:(CSTheme *)theme;/**< 加载主题 */
@end

/***************************************************************
 *  主题基类
 ***************************************************************/
@interface CSTheme : NSObject
